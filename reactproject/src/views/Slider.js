...
import banner from "../images/slider/banner-bg.jpg";
import chicken1 from "../images/slider/first-slider.png";
import chicken2 from "../images/slider/baner1.png";
  ...
  return (
    ...
    <Carousel className="hero"  activeIndex={index} onSelect={handleSelect}>
      ...
      <Container>
            ...
            </Row><ul className="social-links d-flex list-unstyled mt-5 " >
      ...
      <Container>
            ...
            </Row><ul className="social-links list-unstyled d-flex  mt-5 " >
        <li className="me-5"><a href="">Facebook</a></li>
        <li className="me-5"><a href="">Instagram </a></li>
        <li className="me-5"><a href="">Twitter</a></li>
      </ul>
