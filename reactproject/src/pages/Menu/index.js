...
import "./Menu.css";
const menuItems = [
  { id: 1, image: dish1, itemName: "Lumpia with Sauce", category: "Vegan", price: 12, itemDescription: "Lorem ipsum dolor sit, consectetur adipiscing elit, sed do eiusmod tempor",},
  { id: 2, image: dish2, itemName: "Fish and Veggie", category: "Seafood", price: 15, itemDescription: "Lorem ipsum dolor sit, consectetur adipiscing elit, sed do eiusmod tempor",},
  { id: 3, image: dish3, itemName: "Tofu Chili", category: "Lunch", price: 10, itemDescription: "Lorem ipsum dolor sit, consectetur adipiscing elit, sed do eiusmod tempor",},
  { id: 4, image: dish4, itemName: "Egg and Cocumber", category: "Breakfast", price: 10, itemDescription:"Lorem ipsum dolor sit, consectetur adipiscing elit, sed do eiusmod tempor",},
];
      ...
      <section className="menuContainer">
        <section className="container py-4">
          <div className="text-center py-5">
            ...
            <p className="lead m-auto">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</p>
          </div>
